	...
	<div class="flex flex-col p-4">
		<div class="flex w-full items-end justify-between">
			<div class="flex flex-col">
				...
				<div
					class="flex flex-row-reverse justify-end items-center gap-3 text-sm font-semibold text-slate-400"
				>
					{#if hasAudio}
		...
		{#if hasTags}
			<div
				class="mt-1 flex flex-wrap items-center gap-2 text-sm font-semibold leading-none text-slate-400 underline"
			>
				{#each tags as tag}
					<a href="#">{tag}</a>
				{/each}
